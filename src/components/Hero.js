        ...
        <div className="bg-white py-16">
            <div className="max-w-6xl mx-auto px-4">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-gray-900">Hi, I'm Woosik</h1>
                    <p className="mt-4 text-l text-gray-600"> Mechanical Engineer, Bodybuilder, Fitness Coach, Software Developer, DIY & 3D printing Enthusiast, Problem Solver</p>
